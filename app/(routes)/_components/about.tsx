...
const About = () => {
  return (
    <section className="bg-white pt-14 lg:mt-24">
      <div
        className="mx-auto flex scroll-mt-48 items-center justify-between lg:w-[87%]"
        id="about"
      >
      ...
      <div className="flex items-center justify-center gap-x-4 pt-7 md:hidden">
